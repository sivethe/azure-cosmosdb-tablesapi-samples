This sample demonstrates using WindowsAzure.Storage-PremiumTable package in an Azure Web Job.  The original sample is cloned from https://github.com/Azure/azure-webjobs-sdk-samples/tree/master/BasicSamples/TableOperations (below)
